...
INSERT INTO User (version, office_id, first_name, second_name, middle_name, position, phone, identity_id, citizenship_code)
VALUES (0, 1, 'Иванов', 'Иван', 'Иванович', 'Директор', '777', 1, 643),
       (0, 3, 'Петров', 'Петр', 'Петрович', 'Программист', '256', 2, 840),
       (0, 5, 'Мартынов', 'Мартын', 'Мартынович', 'Менеджер', '111', 3, 276);