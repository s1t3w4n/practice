...
VALUES (0, 1, 'Иванов', 'Иван', 'Иванович', 'Директор', '777', 1),
       (0, 3, 'Петров', 'Петр', 'Петрович', 'Программист', '256', 4),
       (0, 5, 'Мартынов', 'Мартын', 'Мартынович', 'Менеджер', '111', 5);


INSERT INTO Identity (version, doc_id, doc_number, doc_date, user_id)
VALUES (0, 1, '123456789', '2010-10-10', 1),
       (0, 2, '234567891', '2011-11-11', 2),
       (0, 4, '456789123', '2013-01-13', 3);