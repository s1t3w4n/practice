INSERT INTO Doc (version, code, name)
VALUES (0, 03, 'Свидетельство о рождении'),
       ...
       (0, 15, 'Разрешение на временное проживание в РФ'),
...
INSERT INTO Identity (version, doc_id, doc_number, doc_date)
VALUES (0, 1, '123456789', '2010-10-10'),
       (0, 2, '234567891', '2011-11-11'),
       (0, 3, '345678912', '2012-12-12'),
       (0, 4, '456789123', '2013-01-13');

INSERT INTO User (version, office_id, first_name, second_name, middle_name, position, phone, identity_id, citizenship_id)
VALUES (0, 1, 'Иванов', 'Иван', 'Иванович', 'Директор', '777', 1, 1),
       (0, 3, 'Петров', 'Петр', 'Петрович', 'Программист', '256', 2, 4),
       (0, 5, 'Мартынов', 'Мартын', 'Мартынович', 'Менеджер', '111', 3, 5);