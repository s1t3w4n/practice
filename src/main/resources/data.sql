...
INSERT INTO USER (version, office_id, first_name, second_name, middle_name, position, phone)
VALUES (0, 1, 'Иванов', 'Иван', 'Иванович', 'Директор', '777'),
       (0, 3, 'Петров', 'Петр', 'Петрович', 'Программист', '256'),
       (0, 5, 'Мартынов', 'Мартын', 'Мартынович', 'Менеджер', '111');